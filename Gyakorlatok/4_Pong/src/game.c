...
void handle_game_events(Game* game)
{
    ...
    while (SDL_PollEvent(&event)) {
        ...
        //Labda áthelyezése kattintással
        case SDL_MOUSEBUTTONDOWN:
            SDL_GetMouseState(&mouse_x, &mouse_y);
            ball_placement(&(game->pong), mouse_x, mouse_y);
            break;
        ...
        case SDL_KEYDOWN:
            ...
            case SDL_SCANCODE_ESCAPE:
                ...
                break;
            case SDL_SCANCODE_W:
                set_left_pad_speed(&(game->pong), -500); //bal pad sebessége módosítva
                break;
            case SDL_SCANCODE_S:
                set_left_pad_speed(&(game->pong), +500); //bal pad sebessége módosítva
                break;
			...
			case SDL_SCANCODE_A:  
				radius_ball_plus(&(game->pong));
                break;
            case SDL_SCANCODE_B:
				radius_ball_minus(&(game->pong));
                break;	
